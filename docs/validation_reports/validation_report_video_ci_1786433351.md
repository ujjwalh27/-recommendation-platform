...
## Video Asset Details
* **Video ID**: `video_ci_1786433351`
* **Duration**: `31.21 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 5.2s]**: Scene keyframe 0 displaying visual elements: {'name': 'Statues', 'description': 'Intricately decorated statues representing Hindu deities'}, {'na
- **Scene [5.2s - 10.4s]**: Scene keyframe 1 displaying visual elements: {'name': 'Statues', 'description': 'Intricately decorated statues representing Hindu deities'}, {'na
- **Scene [10.4s - 15.6s]**: Scene keyframe 2 displaying visual elements: {'name': 'Statues', 'description': 'Intricately decorated statues representing Hindu deities'}, {'na
- **Scene [15.6s - 31.2s]**: Scene keyframe 3 displaying visual elements: {'name': 'Statues', 'description': 'Intricately decorated statues representing Hindu deities'}, {'na
...
* **Summary**: The video captures a vibrant devotional worship scene featuring intricately decorated statues of Hindu deities amidst an abundance of flowers. The accompanying music adds to the spiritual ambiance.
* **Category**: Pooja | **Subcategory**: Devotional Ritual & Worship
* **Primary Topic**: Hindu Deity Worship in a Temple Shrine
* **Secondary Topics**: Decorative Floral Arrangements, Traditional Hindu Attire
* **Language**: English
* **Mood**: Spirital and Reverent | **Emotion**: Devotional
* **Target Audience**: Religious Devotees, Culture Enthusiasts
* **Reasoning Explanation**: The video showcases a detailed depiction of Hindu worship practices, emphasizing the importance of devotion through vibrant decorations and traditional attire. The accompanying music enhances the spiritual atmosphere.
...
* **Visual Object Detections (YOLO/CLIP)**:
  ...
  - `Computer screen or software ui` (Confidence: 0.23)
