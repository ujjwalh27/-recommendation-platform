...
## Video Asset Details
* **Video ID**: `video_ci_1785490247`
* **Duration**: `31.21 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 5.2s]**: Scene keyframe 0 displaying visual elements: {'name': 'Statues', 'description': 'Intricately decorated statues representing divine figures.'}, {'
- **Scene [5.2s - 10.4s]**: Scene keyframe 1 displaying visual elements: {'name': 'Statues', 'description': 'Intricately decorated statues representing divine figures.'}, {'
- **Scene [10.4s - 15.6s]**: Scene keyframe 2 displaying visual elements: {'name': 'Statues', 'description': 'Intricately decorated statues representing divine figures.'}, {'
- **Scene [15.6s - 31.2s]**: Scene keyframe 3 displaying visual elements: {'name': 'Statues', 'description': 'Intricately decorated statues representing divine figures.'}, {'
...
* **Summary**: The video captures a vibrant devotional worship scene featuring intricately decorated statues representing deities. The environment suggests it takes place within a temple or shrine adorned with colorful flowers and garlands, creating an atmosphere of spiritual reverence.
* **Category**: Devotion | **Subcategory**: Religious Worship
* **Primary Topic**: Deity Worship in a Devotional Setting
* **Secondary Topics**: Decorative Offerings, Spiritual Atmosphere
* **Language**: English
* **Mood**: Calm and Spiritual | **Emotion**: Devotional
* **Target Audience**: Religious followers, particularly those practicing Hinduism
* **Reasoning Explanation**: The visual elements of the shrine's decoration and the audio content describing a devotional worship ritual indicate that this video is focused on religious devotion within a temple setting.
...
* **Visual Object Detections (YOLO/CLIP)**:
  - `Temple, shrine, or devotional place` (Confidence: 0.60)
