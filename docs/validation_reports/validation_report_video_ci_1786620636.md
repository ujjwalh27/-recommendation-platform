...
## Video Asset Details
* **Video ID**: `video_ci_1786620636`
* **Duration**: `30.07 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 5.0s]**: Scene keyframe 0 displaying visual elements: {'name': 'Sacred stone idol', 'description': 'Decorated with flowers, jewelry, and a crown.'}, {'nam
- **Scene [5.0s - 16.0s]**: Scene keyframe 1 displaying visual elements: {'name': 'Sacred stone idol', 'description': 'Decorated with flowers, jewelry, and a crown.'}, {'nam
- **Scene [16.0s - 20.0s]**: Scene keyframe 2 displaying visual elements: {'name': 'Sacred stone idol', 'description': 'Decorated with flowers, jewelry, and a crown.'}, {'nam
- **Scene [20.0s - 30.1s]**: Scene keyframe 3 displaying visual elements: {'name': 'Sacred stone idol', 'description': 'Decorated with flowers, jewelry, and a crown.'}, {'nam
...
* **Primary Topic**: A religious devotion ritual involving the worship of a deity represented by a stone idol adorned with flowers and jewelry.
* **Secondary Topics**: Ritualistic practices, Deity worship
* **Language**: English
* **Mood**: Spiritual | **Emotion**: Devotional and reverent
* **Target Audience**: Individuals interested in religious practices, particularly those of Hindu faith.
* **Reasoning Explanation**: The visual cues such as the sacred stone idol adorned with flowers and jewelry, along with individuals performing rituals around it, indicate a devotional ceremony. The audio transcript further supports this by mentioning folk music associated with temple ceremonies.
