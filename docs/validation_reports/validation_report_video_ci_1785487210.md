...
## Video Asset Details
* **Video ID**: `video_ci_1785487210`
* **Duration**: `12.27 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 7.0s]**: Scene keyframe 0 displaying visual elements: 
- **Scene [7.0s - 12.3s]**: Scene keyframe 1 displaying visual elements: 
...
* **Visual Object Detections (YOLO/CLIP)**:
  - `Temple, shrine, or devotional place` (Confidence: 0.67)
  - `Stage with music performance` (Confidence: 0.20)
