...
## Video Asset Details
* **Video ID**: `video_ci_1786531828`
* **Duration**: `30.07 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 5.0s]**: Scene keyframe 0 displaying visual elements: {'name': 'Sacred stone', 'description': 'Adorned with floral garlands, jewelry, and placed on an orn
- **Scene [5.0s - 16.0s]**: Scene keyframe 1 displaying visual elements: {'name': 'Sacred stone', 'description': 'Adorned with floral garlands, jewelry, and placed on an orn
- **Scene [16.0s - 20.0s]**: Scene keyframe 2 displaying visual elements: {'name': 'Sacred stone', 'description': 'Adorned with floral garlands, jewelry, and placed on an orn
- **Scene [20.0s - 30.1s]**: Scene keyframe 3 displaying visual elements: {'name': 'Sacred stone', 'description': 'Adorned with floral garlands, jewelry, and placed on an orn
...
* **Primary Topic**: The primary topic revolves around religious devotion through rituals in a temple setting.
* **Secondary Topics**: Rituals, Deity Worship
* **Language**: English
* **Mood**: Solemn and Devotional | **Emotion**: Serious, Reverent
* **Target Audience**: Individuals interested in religious practices, Devotees of the deity being worshipped
* **Reasoning Explanation**: The visual elements such as sacred objects, ceremonial actions, and attire indicate a deep-rooted cultural or spiritual event. The audio content reinforces this by mentioning devotion and rituals associated with temple worship.
