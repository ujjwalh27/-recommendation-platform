...
## Video Asset Details
* **Video ID**: `video_ci_1785734384`
* **Duration**: `12.10 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 7.0s]**: Scene keyframe 0 displaying visual elements: {'name': 'Flame-lit Lamps', 'description': 'Lamps with flames and floral decorations, used in the ce
- **Scene [7.0s - 10.0s]**: Scene keyframe 1 displaying visual elements: {'name': 'Flame-lit Lamps', 'description': 'Lamps with flames and floral decorations, used in the ce
- **Scene [10.0s - 12.0s]**: Scene keyframe 2 displaying visual elements: {'name': 'Flame-lit Lamps', 'description': 'Lamps with flames and floral decorations, used in the ce
- **Scene [12.0s - 12.1s]**: Scene keyframe 3 displaying visual elements: {'name': 'Flame-lit Lamps', 'description': 'Lamps with flames and floral decorations, used in the ce
...
* **Secondary Topics**: Flame-lit Lamps, Crowd Gathering
* **Language**: English
* **Mood**: Spiritual and Reverent | **Emotion**: [{'name': 'Devotional'}, {'name': 'Serious'}]
* **Target Audience**: Religious Followers, Cultural Enthusiasts
* **Reasoning Explanation**: The video showcases a nighttime devotional ceremony with flame-lit lamps, indicating a spiritual and reverent atmosphere. The presence of a crowd suggests it is an important communal event.
...
* **Visual Object Detections (YOLO/CLIP)**:
  ...
  - `Stage with music performance` (Confidence: 0.39)
  - `Temple, shrine, or devotional place` (Confidence: 0.33)
  - `Computer screen or software ui` (Confidence: 0.11)
