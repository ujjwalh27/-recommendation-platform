...
## Video Asset Details
* **Video ID**: `video_ci_1785910972`
* **Duration**: `12.10 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 7.0s]**: Scene keyframe 0 displaying visual elements: {'type': 'Lamps', 'description': 'Flame-lit lamps with orange flowers, used in the ritual performanc
- **Scene [7.0s - 10.0s]**: Scene keyframe 1 displaying visual elements: {'type': 'Lamps', 'description': 'Flame-lit lamps with orange flowers, used in the ritual performanc
- **Scene [10.0s - 12.0s]**: Scene keyframe 2 displaying visual elements: {'type': 'Lamps', 'description': 'Flame-lit lamps with orange flowers, used in the ritual performanc
- **Scene [12.0s - 12.1s]**: Scene keyframe 3 displaying visual elements: {'type': 'Lamps', 'description': 'Flame-lit lamps with orange flowers, used in the ritual performanc
...
* **Summary**: The video captures a nighttime devotional ceremony where an individual performs rituals with flame-lit lamps. The scene includes a crowd in attendance, indicating a communal event.
* **Category**: Devotion | **Subcategory**: Religious Rituals
* **Primary Topic**: Nighttime Devotional Ceremony
* **Secondary Topics**: Ritualistic Practices, Community Gathering
* **Language**: English
* **Mood**: Spiritual and Devotional | **Emotion**: [{'name': 'Devotion'}, {'name': 'Energetic'}]
* **Target Audience**: Religious Followers, Cultural Enthusiasts
* **Reasoning Explanation**: The video depicts a nighttime devotional ceremony with traditional rituals, indicating the cultural and spiritual significance of such events. The presence of a large crowd suggests its importance to community members.
...
* **Visual Object Detections (YOLO/CLIP)**:
  ...
  - `Temple, shrine, or devotional place` (Confidence: 0.29)
  - `Stage with music performance` (Confidence: 0.28)
