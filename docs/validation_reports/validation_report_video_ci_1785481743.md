...
## Video Asset Details
* **Video ID**: `video_ci_1785481743`
* **Duration**: `49.90 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 1.0s]**: Scene keyframe 0 displaying visual elements: {'description': 'Flower garlands and deity statues adorned with flowers', 'count': 'Multiple'}
- **Scene [1.0s - 7.0s]**: Scene keyframe 1 displaying visual elements: {'description': 'Flower garlands and deity statues adorned with flowers', 'count': 'Multiple'}
- **Scene [7.0s - 47.0s]**: Scene keyframe 2 displaying visual elements: {'description': 'Flower garlands and deity statues adorned with flowers', 'count': 'Multiple'}
- **Scene [47.0s - 49.9s]**: Scene keyframe 3 displaying visual elements: {'description': 'Flower garlands and deity statues adorned with flowers', 'count': 'Multiple'}
...
* **Summary**: The video captures a devotional ceremony at ISKCON Bengaluru, featuring ritualistic activities involving deity statues adorned with flowers. The audio includes thanks for watching and mentions of no selfies allowed.
* **Category**: Devotion | **Subcategory**: Religious Ceremonies
* **Primary Topic**: ISKCON Bengaluru Uruhbr Devotional Ceremony
* **Secondary Topics**: Deity Worship, Ritualistic Activities
* **Language**: English
* **Mood**: Spiritual | **Emotion**: Devotional
