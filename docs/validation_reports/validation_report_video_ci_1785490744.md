...
## Video Asset Details
* **Video ID**: `video_ci_1785490744`
* **Duration**: `30.07 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 5.0s]**: Scene keyframe 0 displaying visual elements: {'name': 'Sacred Stone'}, {'name': 'Bowl of liquid being poured', 'description': 'A bowl from which 
- **Scene [5.0s - 16.0s]**: Scene keyframe 1 displaying visual elements: {'name': 'Sacred Stone'}, {'name': 'Bowl of liquid being poured', 'description': 'A bowl from which 
- **Scene [16.0s - 20.0s]**: Scene keyframe 2 displaying visual elements: {'name': 'Sacred Stone'}, {'name': 'Bowl of liquid being poured', 'description': 'A bowl from which 
- **Scene [20.0s - 30.1s]**: Scene keyframe 3 displaying visual elements: {'name': 'Sacred Stone'}, {'name': 'Bowl of liquid being poured', 'description': 'A bowl from which 
...
* **Summary**: The video captures a religious ceremony taking place inside a temple, where devotees are seen performing rituals around a sacred stone. The audio includes music that enhances the spiritual ambiance of the scene.
* **Category**: Religion | **Subcategory**: Hindu Devotion
* **Primary Topic**: A Hindu devotional ritual involving a sacred stone and offerings to deities.
* **Secondary Topics**: Rituals, Offerings
* **Language**: English
* **Mood**: Solemn and Reverent | **Emotion**: ['Devotional', 'Serious']
* **Target Audience**: Hindu Devotees, Religious Practitioners
...
* **Visual Object Detections (YOLO/CLIP)**:
  - `person` (Confidence: 0.71)
  - `bowl` (Confidence: 0.52)
  - `Temple, shrine, or devotional place` (Confidence: 0.97)
