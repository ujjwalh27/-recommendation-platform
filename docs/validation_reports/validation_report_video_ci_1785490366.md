...
## Video Asset Details
* **Video ID**: `video_ci_1785490366`
* **Duration**: `30.07 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 5.0s]**: Scene keyframe 0 displaying visual elements: {'name': 'Sacred Object', 'description': 'A large, ornate vessel or stone with water flowing from it
- **Scene [5.0s - 16.0s]**: Scene keyframe 1 displaying visual elements: {'name': 'Sacred Object', 'description': 'A large, ornate vessel or stone with water flowing from it
- **Scene [16.0s - 20.0s]**: Scene keyframe 2 displaying visual elements: {'name': 'Sacred Object', 'description': 'A large, ornate vessel or stone with water flowing from it
- **Scene [20.0s - 30.1s]**: Scene keyframe 3 displaying visual elements: {'name': 'Sacred Object', 'description': 'A large, ornate vessel or stone with water flowing from it
...
* **Summary**: The video captures a devotional ceremony taking place inside what appears to be a temple or shrine. Individuals are seen performing rituals around an ornate sacred object.
* **Category**: Devotion | **Subcategory**: Religious Rituals
* **Primary Topic**: A religious devotion involving the worship of a deity through ritualistic practices and offerings.
* **Secondary Topics**: Ritual, Offerings
* **Language**: English
* **Mood**: Solemn and Devotional | **Emotion**: ['Devotional', 'Respectful']
* **Target Audience**: Individuals interested in religious practices, particularly those of Hindu faith.
* **Reasoning Explanation**: The visual cues such as the sacred object, ritualistic actions, traditional attire, and offerings indicate a devotional ceremony. The audio transcription provides context about the ongoing devotion.
...
* **Visual Object Detections (YOLO/CLIP)**:
  ...
  - `Temple, shrine, or devotional place` (Confidence: 0.50)
  - `Person talking to camerin reel or video` (Confidence: 0.26)
