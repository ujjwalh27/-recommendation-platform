...
## Video Asset Details
* **Video ID**: `video_ci_1786535193`
* **Duration**: `9.00 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 1.5s]**: Scene keyframe 0 displaying visual elements: {'name': 'Altar setup', 'description': 'Decorated with flowers and religious items like a bell, lamp
- **Scene [1.5s - 3.0s]**: Scene keyframe 1 displaying visual elements: {'name': 'Altar setup', 'description': 'Decorated with flowers and religious items like a bell, lamp
- **Scene [3.0s - 4.5s]**: Scene keyframe 2 displaying visual elements: {'name': 'Altar setup', 'description': 'Decorated with flowers and religious items like a bell, lamp
- **Scene [4.5s - 9.0s]**: Scene keyframe 3 displaying visual elements: {'name': 'Altar setup', 'description': 'Decorated with flowers and religious items like a bell, lamp
...
* **Summary**: The sequence of frames captures individuals participating in a devotional ceremony within a temple or shrine. The participants are dressed in traditional attire, engaging with religious artifacts and performing rituals around an altar adorned with flowers.
* **Category**: Pooja | **Subcategory**: Devotional Ritual & Worship
* **Primary Topic**: A spiritual gathering involving ritualistic practices
* **Secondary Topics**: Traditional clothing, Rituals, Altar setup
* **Language**: English
* **Mood**: Serious and Devotional | **Emotion**: Devotional, Serious
* **Target Audience**: Religious practitioners
* **Reasoning Explanation**: The visual elements such as traditional attire, religious artifacts, and the altar setup indicate a devotional ceremony. The audio transcript confirms this with mentions of bells typically used in temple rituals.
