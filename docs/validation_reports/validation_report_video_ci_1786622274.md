...
## Video Asset Details
* **Video ID**: `video_ci_1786622274`
* **Duration**: `59.73 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 9.9s]**: Scene keyframe 0 displaying visual elements: {'name': 'Sacred Object', 'description': 'A large, dark-colored object placed on a silver pedestal. 
- **Scene [9.9s - 19.9s]**: Scene keyframe 1 displaying visual elements: {'name': 'Sacred Object', 'description': 'A large, dark-colored object placed on a silver pedestal. 
- **Scene [19.9s - 29.9s]**: Scene keyframe 2 displaying visual elements: {'name': 'Sacred Object', 'description': 'A large, dark-colored object placed on a silver pedestal. 
- **Scene [29.9s - 59.7s]**: Scene keyframe 3 displaying visual elements: {'name': 'Sacred Object', 'description': 'A large, dark-colored object placed on a silver pedestal. 
...
* **Summary**: The sequence of frames depicts an individual performing devotional rituals in front of a sacred object, likely within a temple or shrine. The person is seen engaging with the deity through offerings and prayers.
* **Category**: Devotion | **Subcategory**: Religious Rituals
* **Primary Topic**: Religious Worship
* **Secondary Topics**: Offerings, Deity Veneration
* **Language**: Hindi
* **Mood**: Calm and Spiritual | **Emotion**: Serious, Devotional
* **Target Audience**: Religious Followers
* **Reasoning Explanation**: The visual elements such as the sacred object, religious attire of the individual performing rituals, and offerings indicate a devotional ceremony. The audio content includes prayers or chants which supports this interpretation.
...
* **Visual Object Detections (YOLO/CLIP)**:
  ...
  - `Computer screen or software ui` (Confidence: 0.09)
