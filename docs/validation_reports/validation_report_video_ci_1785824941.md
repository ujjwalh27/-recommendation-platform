...
## Video Asset Details
* **Video ID**: `video_ci_1785824941`
* **Duration**: `31.21 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 5.2s]**: Scene keyframe 0 displaying visual elements: {'description': 'Statues of Lord Krishna and Goddess Radha, adorned with jewelry and vibrant clothin
- **Scene [5.2s - 10.4s]**: Scene keyframe 1 displaying visual elements: {'description': 'Statues of Lord Krishna and Goddess Radha, adorned with jewelry and vibrant clothin
- **Scene [10.4s - 15.6s]**: Scene keyframe 2 displaying visual elements: {'description': 'Statues of Lord Krishna and Goddess Radha, adorned with jewelry and vibrant clothin
- **Scene [15.6s - 31.2s]**: Scene keyframe 3 displaying visual elements: {'description': 'Statues of Lord Krishna and Goddess Radha, adorned with jewelry and vibrant clothin
...
* **Language**: English
* **Mood**: Spirited and Reverent | **Emotion**: Devotional, Reverential
* **Target Audience**: Individuals interested in Hinduism or Devotional Worship
* **Reasoning Explanation**: The visual elements of the shrine, along with the audio transcription mentioning Lord Krishna and worship rituals, suggest a focus on religious devotion. The presence of flowers and garlands indicates an ongoing celebration or ritualistic offering.
...
* **Visual Object Detections (YOLO/CLIP)**:
  - `bench` (Confidence: 0.44)
  - `Temple, shrine, or devotional place` (Confidence: 0.70)
  - `Computer screen or software ui` (Confidence: 0.20)
