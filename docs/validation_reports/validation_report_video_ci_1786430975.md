...
## Video Asset Details
* **Video ID**: `video_ci_1786430975`
* **Duration**: `45.07 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 14.0s]**: Scene keyframe 0 displaying visual elements: {'name': "Deity's Idol", 'details': 'The idol is adorned with yellow and green garlands.'}, {'name':
- **Scene [14.0s - 21.0s]**: Scene keyframe 1 displaying visual elements: {'name': "Deity's Idol", 'details': 'The idol is adorned with yellow and green garlands.'}, {'name':
- **Scene [21.0s - 45.1s]**: Scene keyframe 2 displaying visual elements: {'name': "Deity's Idol", 'details': 'The idol is adorned with yellow and green garlands.'}, {'name':
...
* **Primary Topic**: A Devotional Ceremony at a Temple
* **Secondary Topics**: Milk Pouring, Deity Worship
* **Language**: English
* **Mood**: Spiritual and Reverent | **Emotion**: Devotional, Respectful
* **Target Audience**: Individuals interested in religious practices
* **Reasoning Explanation**: The visual elements of the video depict a traditional ritual with milk being poured over an idol, accompanied by floral decorations. The audio includes Tamil language that suggests themes of devotion and blessings.
...
* **Visual Object Detections (YOLO/CLIP)**:
  ...
  - `Temple, shrine, or devotional place` (Confidence: 0.34)
  - `Person talking to camerin reel or video` (Confidence: 0.25)
  - `Stage with music performance` (Confidence: 0.09)
