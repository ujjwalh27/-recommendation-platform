...
## Video Asset Details
* **Video ID**: `video_ci_1785490819`
* **Duration**: `31.21 seconds`

---

## 👁️ Visual Timeline & Scenes
- **Scene [0.0s - 5.2s]**: Scene keyframe 0 displaying visual elements: {'description': 'Intricately decorated statues with floral garlands'}, {'description': 'Colorful flo
- **Scene [5.2s - 10.4s]**: Scene keyframe 1 displaying visual elements: {'description': 'Intricately decorated statues with floral garlands'}, {'description': 'Colorful flo
- **Scene [10.4s - 15.6s]**: Scene keyframe 2 displaying visual elements: {'description': 'Intricately decorated statues with floral garlands'}, {'description': 'Colorful flo
- **Scene [15.6s - 31.2s]**: Scene keyframe 3 displaying visual elements: {'description': 'Intricately decorated statues with floral garlands'}, {'description': 'Colorful flo
...
* **Category**: Devotion | **Subcategory**: Hindu Worship
* **Primary Topic**: Lord Krishna Devotion
* **Secondary Topics**: Decorative Floral Arrangements, Hindu Deity Worship
* **Language**: English
* **Mood**: Spirited and Reverent | **Emotion**: ['Devotional', 'Calm']
* **Target Audience**: Religious Devotees of Lord Krishna, Individuals Interested in Hindu Culture
* **Reasoning Explanation**: The video showcases a detailed depiction of a devotional shrine, emphasizing the vibrant and reverent atmosphere associated with worship practices within Hinduism.
...
* **Visual Object Detections (YOLO/CLIP)**:
  ...
  - `Computer screen or software ui` (Confidence: 0.18)
